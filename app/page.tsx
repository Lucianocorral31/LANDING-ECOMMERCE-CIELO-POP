...
import { getFeaturedProductsAction } from "@/actions/shop-actions"
import { ProductCard } from "@/components/shop/product-card"
import { CartSidebar } from "@/components/shop/cart-sidebar"
import { CheckoutForm } from "@/components/shop/checkout-form"

export default async function CieloPop() {
  const featuredProductsResult = await getFeaturedProductsAction()
  const featuredProducts = featuredProductsResult.success ? featuredProductsResult.data : []
      ...
      <div className="min-h-screen bg-gradient-to-b from-sky-100 via-white to-sky-50">
        ...
        <header className="relative z-10 px-4 lg:px-6 h-20 flex items-center border-b border-sky-200/50 bg-white/80 backdrop-blur-sm sticky top-0">
          <div className="container mx-auto flex items-center justify-between">
            ...
            <nav className="hidden md:flex gap-6">
              ...
              <Link href="#tienda" className="text-sm font-medium text-slate-700 hover:text-sky-600 transition-colors">
                Tienda
              </Link>
              <Link
                href="#contacto"
        ...
        <main className="relative z-10">
            ...
            <div className="container mx-auto px-4">
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                  Soluciones integrales de marketing digital para hacer despegar tu negocio hacia nuevas alturas de
                  éxito
                </p>
              </div>
                ...
                <Card className="group hover:shadow-xl transition-all duration-300 border-sky-100 hover:border-sky-300">
                  <CardContent className="p-6">
                    ...
                    <p className="text-slate-600 mb-4">
                      Contenido visual, escrito y audiovisual que conecta con tu audiencia y genera engagement
                      auténtico.
                    </p>
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600">
                          Desarrollamos un plan detallado con cronogramas, KPIs y métricas de éxito claras para cada
                          fase del proyecto.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600">
                          Creamos contenido, diseños y desarrollamos las herramientas necesarias con la más alta calidad
                ...
                <Card className="overflow-hidden">
                  ...
                  <CardContent className="p-6">
                    ...
                    <h3 className="text-xl font-semibold text-slate-800 mb-3">
                      Boutique Luna - Transformación Digital
                    </h3>
                    <p className="text-slate-600 mb-4">
                      Ayudamos a esta boutique tucumana a digitalizar completamente su negocio, creando una tienda
                      online que generó un crecimiento del 400% en ventas durante el primer año.
                    </p>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                ...
                <Card className="border-sky-100">
                  <CardContent className="p-6">
                    ...
                    <p className="text-slate-600 mb-4">
                      "La estrategia de contenido que desarrollaron para nosotros generó un engagement increíble.
                      Nuestros seguidores se triplicaron en solo 4 meses."
                    </p>
                    <div className="flex items-center">
                      <div className="w-10 h-10 bg-sky-100 rounded-full flex items-center justify-center mr-3">
                ...
                <Card className="border-sky-100">
                  <CardContent className="p-6">
                    ...
                    <p className="text-slate-600 mb-4">
                      "El sitio web que nos desarrollaron no solo es hermoso, sino que convierte visitantes en clientes
                      de manera increíble. Nuestra tasa de conversión mejoró un 150%."
                    </p>
                    <div className="flex items-center">
                      <div className="w-10 h-10 bg-sky-100 rounded-full flex items-center justify-center mr-3">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                ...
                <Card className="group hover:shadow-lg transition-all duration-300">
                  <CardContent className="p-6">
                    ...
                    <p className="text-slate-600 mb-4">
                      Planificá tu contenido mensual con nuestro calendario editable
                    </p>
                    <Button variant="outline" className="w-full bg-transparent">
                      <Download className="w-4 h-4 mr-2" />
                ...
                <Card className="group hover:shadow-lg transition-all duration-300">
                  <CardContent className="p-6">
                    ...
                    <p className="text-slate-600 mb-4">
                      Aprende cómo implementar inteligencia artificial en tu negocio
                    </p>
                    <Button variant="outline" className="w-full bg-transparent">
          ...
          <section id="tienda" className="py-20">
            <div className="container mx-auto px-4">
              <div className="text-center mb-16">
                <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-6">Tienda Digital</h2>
                <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                  Servicios y paquetes listos para impulsar tu negocio. Elige el que mejor se adapte a tus necesidades.
                </p>
              </div>
              ...
              <div className="text-center">
                <Button variant="outline" className="border-sky-300 text-sky-600 hover:bg-sky-50 bg-transparent">
          ...
          {/* Checkout Section */}
          <section id="checkout" className="py-20 bg-white/50 backdrop-blur-sm">
            <div className="container mx-auto px-4">
              <div className="text-center mb-16">
                <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-6">Finalizar Pedido</h2>
                <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                  Completa tus datos y confirma tu pedido. Te contactaremos para coordinar los detalles.
                </p>
              </div>
